...
LightSource::LightSource(float edgeLength, glm::vec3 eulerXYZ, glm::vec3 position)
{
	...
	shader = new Shader("res/shaders/lightsource.vs", "res/shaders/lightsource.fs");
}


void LightSource::render(glm::mat4 view, glm::mat4 projection)
{
	shader->use();
