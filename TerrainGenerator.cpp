...
//reordered list of ints from 0-256
...
//produce gradient float for hash and x/y coordinate
...
float SimplexNoise::noise(float x, float y) {
    ...
    //produce coordinates with params
    float s = (x + y) * F2;
    float xs = x + s;
    float ys = y + s;
    ...
    //produce different types of gradients
...
float SimplexNoise::fractal(size_t octaves, float x, float y) const {
    ...
    //for octaves, change output and amplitude.
